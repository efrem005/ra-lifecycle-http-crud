[![Crud](https://github.com/efrem005/ra-lifecycle-http-crud/actions/workflows/web.yml/badge.svg)](https://github.com/efrem005/ra-lifecycle-http-crud/actions/workflows/web.yml)
## [GitHub Page](https://efrem005.github.io/ra-lifecycle-http-crud/)
...
Бэкенд можно реализовать самостоятельно или использовать готовый [`backend`](https://github.com/efrem005/ra-lifecycle-http-crud-server).
